...
?>
<?php $this->beginContent('@backend/views/file-browser/file-column.php'); ?>
        ...
        <div class="col-xs-4 col-md-2" style="background-color: #f5f5f5; padding-top: 10px">
            ...
            <ul class="list-unstyled category-list">
                <?php foreach($dataProvider->models as $model): ?>
                    <li class="file-cat">
                        <?php echo Html::a('<i class="glyphicon glyphicon-folder-close"></i>' . Html::encode($model->name), ['view', 'id'=>$model->id, 'CKEditor'=>$_GET['CKEditor'], 'CKEditorFuncNum'=>$_GET['CKEditorFuncNum'], 'langCode'=>'en'], ['class'=>'view-files', 'id'=>$model->name]) ?>
                    </li>
                <?php endforeach ?>
            </ul>
        </div>
